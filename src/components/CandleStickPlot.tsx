      ...
      <Chart
        ...
        options={{
          ...
          xaxis: {
            ...
            range:
              new Date(
                candles[candles.length > 50 ? 50 : candles.length - 1].time
              ).getTime() - new Date(candles[0].time).getTime(), // for inital zoom
            tickPlacement: "on",
            tickAmount: 19,
            labels: {
